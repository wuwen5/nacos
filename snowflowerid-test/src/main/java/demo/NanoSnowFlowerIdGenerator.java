...
public class NanoSnowFlowerIdGenerator implements IdGenerator {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NanoSnowFlowerIdGenerator.class);
